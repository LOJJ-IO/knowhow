...
## Open
- **[deploy / data]** Prisma + SQLite were removed (2026-09-05) so Vercel builds without native sqlite / generated client. Session always returns null; auth and workspace mutations are stubs. App routes that need a DB will not function until a durable store is wired — see [[0002-remove-prisma-for-vercel]]. (since 2026-09-05)
